...
abstract class ReshexModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<ReshexModDependenciesExtension>("reshexModDependencies")
